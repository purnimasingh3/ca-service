        ...
        <div className="min-h-screen bg-slate-50 text-slate-900 font-sans antialiased selection:bg-blue-500 selection:text-white">
                    ...
                    <div className="grid gap-12 lg:grid-cols-12 items-center">
                        ...
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight leading-tight text-white max-w-2xl">
                                Maximise Your Deductions. Secure Your Income Tax Filings.
                            </h1>
                            <p className="text-sm text-slate-300 max-w-xl">
                                From basic salaried returns to complex corporate tax audit compliance—get automated validation pipelines backed by seasoned tax advocates.
                            </p>

                            <div className="inline-block bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-4 sm:p-5 max-w-md w-full">
                                <p className="text-xs font-semibold text-slate-300 tracking-wide uppercase">Income Tax Advisory Services</p>
                                <div className="flex items-baseline gap-2 mt-1">
                                    <span className="text-2xl sm:text-3xl font-black text-white">starting @ ₹2,499/yr</span>
                                    <span className="text-xs font-medium text-orange-300"> tax optimization included</span>
                                </div>
                            </div>

                            <div className="space-y-3 pt-2">
                                <p className="text-sm font-bold text-amber-400">Bulletproof direct tax governance systems:</p>
                                <ul className="grid gap-2 sm:grid-cols-2 text-xs text-slate-200 font-medium">
                                    <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 bg-amber-400 rounded-full shrink-0"></span> Form 16 & 26AS Double Audit Verification</li>
                                    <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 bg-amber-400 rounded-full shrink-0"></span> Advance Tax Estimation Models</li>
                                    <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 bg-amber-400 rounded-full shrink-0"></span> Capital Gains Tracking Frameworks</li>
                                    <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 bg-amber-400 rounded-full shrink-0"></span> Notice Assessment Representation</li>
                                </ul>
                            </div>
                            ...
                            <div className="pt-4 max-w-lg">
                                ...
                                <div className="mt-2 border-l-2 border-orange-500 bg-white/5 rounded-r-xl p-4">
                                    <p className="text-xs text-slate-300 italic leading-relaxed">
                                        "The income tax advisory team completely handled our corporate tax transition. They corrected past computation errors, optimized our advance tax payouts, and simplified our board reporting profiles."
                                    </p>
            ...
            <section className="py-16 bg-white border-b border-slate-100">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <h2 className="text-3xl font-extrabold text-slate-900 sm:text-4xl">Income Tax Compliance Plans</h2>
                    <p className="mt-3 text-sm text-slate-500 max-w-2xl mx-auto">Select a structured direct tax tier designed for your scale.</p>
                            ...
                            <div>
                                ...
                                <div className="mt-8 border-t border-slate-200/60 pt-6">
                                    ...
                                    <ul className="space-y-3 text-xs font-medium text-slate-600">
                                        <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Income Tax Return (ITR) filing</li>
                                        <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Salary, interest & other income reporting</li>
                                        <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Basic tax computation</li>
                                        <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Form 16 & Form 26AS review</li>
                                        {showAllFeatures && (
                                            <>
                                                <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Tax-saving guidance under provisions</li>
                        ...
                        <div className="bg-blue-50/40 border-2 border-blue-400 rounded-3xl p-8 flex flex-col justify-between shadow-xs relative">
                            ...
                            <div>
                                ...
                                <div className="mt-8 border-t border-blue-200/60 pt-6">
                                    ...
                                    <ul className="space-y-3 text-xs font-medium text-slate-600">
                                        <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Business or professional income tax return filing</li>
                                        <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Capital gains & investment reporting</li>
                                        <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Advance tax computation and guidance</li>
                                        <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Tax planning consultation</li>
                                        {showAllFeatures && (
                                            <>
                                                <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Response assistance for Income Tax notices</li>
                        ...
                        <div className="bg-slate-50/50 border border-slate-200/60 rounded-3xl p-8 flex flex-col justify-between transition-all hover:shadow-md">
                            <div>
                                ...
                                <div className="mt-8 border-t border-slate-200/60 pt-6">
                                    ...
                                    <ul className="space-y-3 text-xs font-medium text-slate-600">
                                        <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Tax filing for companies, LLPs, or partnership firms</li>
                                        <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Comprehensive tax planning and advisory[cite: 2]</li>
                                        <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Advance tax & TDS compliance guidance[cite: 2]</li>
                                        <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Representation support for Income Tax notices[cite: 2]</li>
                                        {showAllFeatures && (
                                            <>
                                                <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Dedicated tax consultant[cite: 2]</li>
                                                <li className="flex items-center gap-2.5"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Quarterly tax review meetings[cite: 2]</li>
                                            </>
                                        )}
                                    </ul>
                                </div>
                    ...
                    <div className="overflow-x-auto border border-slate-200 rounded-2xl bg-white shadow-xs">
                        <table className="w-full text-left border-collapse text-xs">
                            ...
                            <tbody className="divide-y divide-slate-100 font-medium text-slate-600">
                                <tr><td className="p-4 font-bold text-slate-900">Form 16 Assessment</td><td className="p-4 text-emerald-600 font-bold">✓</td><td className="p-4 text-emerald-600 font-bold">✓</td><td className="p-4 text-emerald-600 font-bold">✓</td></tr>
                                <tr><td className="p-4 font-bold text-slate-900">Capital Gains Audit</td><td className="p-4 text-slate-400">—</td><td className="p-4 text-emerald-600 font-bold">✓</td><td className="p-4 text-emerald-600 font-bold">✓</td></tr>
                                <tr><td className="p-4 font-bold text-slate-900">Corporate Audit ITR-6</td><td className="p-4 text-slate-400">—</td><td className="p-4 text-slate-400">—</td><td className="p-4 text-emerald-600 font-bold">✓</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            {/* REVIEWS SECTION WITH BRAND NEW CUSTOM INCOME TAX TRANSACTIONS */}
            <section className="py-20 bg-slate-50/50 border-b border-slate-100">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <h2 className="text-3xl font-extrabold text-slate-900">What Our Tax Clients Say</h2>
                    <div className="mt-12 grid gap-6 sm:grid-cols-3 max-w-5xl mx-auto text-left">
                        {[
                            { text: "Filing capital gains and startup ESOP computations used to be a complete mess for me. Their premium tax panel reconciled everything in two days flat.", author: "Arjun Deshmukh", initial: "AD" },
                            { text: "Extremely professional work logic. They handled an old assessment notice from 2022 cleanly without requiring any repetitive physical visits.", author: "Kritika Iyer", initial: "KI" },
                            { text: "Clean and fast process. The interactive computational sheet they shared before final upload saved us over ₹40,000 in wrong tax headers.", author: "Sanjay Singhania", initial: "SS" }
                        ].map((t, idx) => (
                            <div key={idx} className="bg-white border border-slate-200/60 rounded-2xl p-6 shadow-2xs flex flex-col justify-between">
                                ...
                                <div className="mt-6 flex items-center gap-3 border-t border-slate-50 pt-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-emerald-600 font-semibold flex items-center gap-1">✓ Verified Google Tax Review</p>
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="py-16 bg-white">
                <div className="mx-auto max-w-4xl px-4">
                    ...
                    <div className="space-y-0 border-t border-slate-200">
                        {[
                            { q: "What is Income Tax Compliance?", a: "Income Tax Compliance refers to the process of ensuring that a business adheres to all applicable income tax laws and regulations." },
                            { q: "Who needs Income Tax Compliance?", a: "Businesses that need to ensure they are meeting all applicable income tax obligations." },
                            { q: "Why is timely Income Tax Compliance important?", a: "Timely Income Tax Compliance is important to avoid penalties, ensure legal compliance, and maintain the financial health of the business." },
                            { q: "What documents are required for Income Tax Compliance?", a: "The required documents may include PAN, Aadhaar, bank statements, Form 16, financial statements, GST details (if applicable), investment proofs, TDS certificates, and other income-related documents." },
                            { q: "Can you help with Income Tax notices?", a: "Yes, we can assist with responding to Income Tax notices and ensuring compliance." },
                            { q: "How long does the Income Tax Compliance process take?", a: "Fintax Adviser offers streamlined filing systems, dedicated corporate account managers, transparent structural pricing tiers, and automated deadline tracking alerts." }
                        ].map((faq, index) => (
