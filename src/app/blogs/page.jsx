...
//   // रियल-टाइम सर्च लॉजिक: जैसे ही search स्टेट बदलेगी, यह तुरंत फ़िल्टर करेगा
...
//   // "Back to Blogs" बटन दबाने पर सर्च बॉक्स खाली हो जाएगा और सब वापस आ जाएगा
...
//       {/* HERO SECTION WITH REAL-TIME INPUT & SEARCH ICON BUTTON */}
...
//             Latest insights for your business, finance, and compliance needs
//           </h1>
//           <p className={styles.heroSubtitle}>
//             Discover articles on GST, taxation, registration, corporate compliance, and startup growth.
//           </p>
...
//                 className={selectedCategory === cat ? styles.activeCategory : styles.categoryBtn}
//               >
//                 {cat}
//               </button>
//             ))}
...
//               We couldn't find any articles matching "{search}". Try checking your spelling or search something else.
//             </p>
//             <button
...
//                         <span className={styles.categoryTag}>{blog.category || 'Uncategorized'}</span>
//                         <h2 className={styles.featuredCardTitle}>{blog.title || 'Untitled'}</h2>
//                         <p className={styles.featuredExcerpt}>{blog.excerpt || 'No excerpt available'}</p>
...
//                               <div>
//                                 <p className="font-semibold">{blog.author || 'Unknown'}</p>
...
//                   <div className={styles.sidebarBannerText}>Get Consultation</div>
//                 </div>
...
//           <p>Weekly insights on GST, taxation and compliance.</p>
//           <form
...
//               color: newsletterStatus.includes('Successfully') ? 'green' : newsletterStatus.includes('Failed') ? 'red' : 'inherit'
//             }}>
//               {newsletterStatus}
//             </p>
//           )}
