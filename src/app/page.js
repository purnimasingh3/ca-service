    ...
    <>
      ...
      <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-2">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="h-12 w-12 bg-emerald-700 rounded-full flex items-center justify-center text-white shadow-lg hover:scale-105 transition-transform animate-[bounce_5s_infinite]"
        >
